...
from Constants import POSITION_OFFSET_DOC, POSITION_OFFSET_PAT, KP, KD, KI, current_threshold
...
def state_1(
    ...
    doc_cur = controllerDoc.motor.readCurrent()
    ...
    print("current doc_postion is: {}".format(doc_pos),
          ...
          "\n current doc_velocity is: {}".format(doc_vel),

          "\n current doc_current is: {}".format(doc_cur))
